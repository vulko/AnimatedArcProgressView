...
import com.kvolkov.animatedprogressviews.annotations.OpacityAnimationType;
import com.kvolkov.animatedprogressviews.annotations.ProgressAnimationType;
 ...
 *  - {@code ProgressAnimationType} for animating arcs.
 *  - {@code OpacityAnimationType} for adding special effects generated by opacity animations for arcs.
 *
...
public class AnimatedArcIndefiniteProgressView extends View {
    ...
    /**
     * Animation durations in [ms] for opacity animation types. See {@code OpacityAnimationType}.
     */
    ...
    /**
     * Animation durations in [ms] for animation types. See {@code ProgressAnimationType}.
     */
    ...
    /**
     * Animation max beta angle initial values. See {@code ProgressAnimationType}.
     */
    ...
    /**
     * Animation initial beta angle initial values. See {@code ProgressAnimationType}.
     */
    ...
    /**
     * Animation initial alpha angle initial values. See {@code ProgressAnimationType}.
     */
    ...
    protected @OpacityAnimationType
    ...
    /**
     * Call this to explicitly restart opacity animation specified by {@code OpacityAnimationType}.
     */
    ...
    /**
     * Call this to explicitly stop opacity animation specified by {@code OpacityAnimationType}.
     */
    ...
    /**
     * Call this to explicitly restart progress animation specified by {@code ProgressAnimationType}.
     */
    ...
    /**
     * Call this to explicitly stop progress animation specified by {@code ProgressAnimationType}.
     */
     ...
     *
     * @param animationType A {@code ProgressAnimationType}.
     */
